"""AILSVRG-ADMM ablation with a cost-matched constant refresh probability."""
...
def run_ailsvrg_admm_fixed_p(
    ...
    config: dict[str, Any], seed: int, *, name: str = "AILSVRG-ADMM-Fixed-p"
) -> RunResult:
